...
public class CapturaHuella extends javax.swing.JDialog {
    ...
    static JPanel contenedor=new JPanel();
    ...
    private void initComponents() {
        ...
        lblImagenHuella.setAutoscrolls(true);
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        imagen1=new ImageIcon(this.getClass().getResource("/imagenes/one_finger.png"));
        contenedor.add(new JLabel(imagen1));
        String texto1 = "<html><body><p style='font-size: 25px'> Para Guardar una huella <br><br> - Ingrese el dedo indice de su mano derecha <br> - Debera repetir este proceso 4 veces </p><p style='font-size: 15px'>* hasta que el boton Guardar se active</p></body></html>";
        contenedor.add(new JLabel(texto1));
        contenedor.setOpaque(false);
        
        JOptionPane.showMessageDialog(null,contenedor,"Como guardar una Huella",JOptionPane.PLAIN_MESSAGE,null);
        Iniciar();
	start();
        EstadoHuellas();
...
ConexionBD con=new ConexionBD();
  ...
  */
    public void guardarHuella(){
     ...
     String rut = JOptionPane.showInputDialog("Rut sin digito verificador ni punto");
     try {
     //Establece los valores para la sentencia SQL
     Connection c=con.conectar(); //establece la conexion con la BD
     PreparedStatement guardarStmt = c.prepareStatement("Update usuario set huella=(?) where rut="+rut);
     
     //guardarStmt.setString(1,nombre);
     guardarStmt.setBinaryStream(1, datosHuella,tamañoHuella);
     //Ejecuta la sentencia
     
     int row = guardarStmt.executeUpdate();
     if(row != 0)
     {JOptionPane.showMessageDialog(null,"Huella Guardada Correctamente");}
     else
     {JOptionPane.showMessageDialog(null,"Rut invalido, igrese su huella nuevamente");}
     ...
     btnGuardar.setEnabled(false);
     JOptionPane.showMessageDialog(null,"Error al guardar la huella \n Verifique el rut ingresado");
     }
     catch (NullPointerException exe){
         JOptionPane.showMessageDialog(null,"ERROR, Rut no valido");
         btnGuardar.setEnabled(false);
         System.err.println("Error al guardar los datos de la huella.");
     }
     finally{
